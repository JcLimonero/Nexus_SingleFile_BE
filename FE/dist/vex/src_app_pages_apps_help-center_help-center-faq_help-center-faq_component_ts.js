"use strict";
(self["webpackChunkvex"] = self["webpackChunkvex"] || []).push([["src_app_pages_apps_help-center_help-center-faq_help-center-faq_component_ts"],{
...
class HelpCenterFaqComponent {
  constructor() {}
  ngOnInit() {}
  static #_ = this.ɵfac = function HelpCenterFaqComponent_Factory(t) {
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
    ...
    decls: 57,
    vars: 1,
    consts: [[1, "bg-foreground", "py-16", "px-6"], [1, "display-1", "mt-12", "mb-4", "text-center"], [1, "subheading-2", "text-hint", "text-center", "max-w-lg", "mx-auto", "m-0"], [1, "my-12", "max-w-3xl", "mx-auto"], [3, "expanded"]],
...
//# sourceMappingURL=src_app_pages_apps_help-center_help-center-faq_help-center-faq_component_ts.js.map