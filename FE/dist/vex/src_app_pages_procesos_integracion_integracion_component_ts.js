...
/* harmony export */   ClientSearchService: () => (/* binding */ ClientSearchService)
/* harmony export */ });
...
class ClientSearchService {
   ...
   */
  searchClients(idAgency, searchTerm, limit = 50) {
    let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpParams();
    params = params.set('idAgency', idAgency.toString());
    params = params.set('search', searchTerm);
    params = params.set('limit', limit.toString());
    return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiBaseUrl}/api/client-search/search`, {
      params
    });
  }
  /**
  ...
  getClientById(id, idAgency) {
    let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpParams();
    params = params.set('idAgency', idAgency.toString());
    return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiBaseUrl}/api/client-search/${id}`, {
      params
    });
  }
  /**
   ...
   */
  getClientsByAgency(idAgency, limit = 100, offset = 0) {
    let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpParams();
    params = params.set('limit', limit.toString());
    params = params.set('offset', offset.toString());
    return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiBaseUrl}/api/client-search/by-agency/${idAgency}`, {
      params
    });
  }
  /**
  ...
  static #_ = this.ɵfac = function ClientSearchService_Factory(t) {
    return new (t || ClientSearchService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient));
  };
  static #_2 = this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
    token: ClientSearchService,
    factory: ClientSearchService.ɵfac,
    providedIn: 'root'
  });
}
