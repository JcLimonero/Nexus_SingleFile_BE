...
@Component({
  selector: 'vex-widget-total-cases',
  templateUrl: './widget-total-cases.component.html',
  styleUrls: ['./widget-total-cases.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    MatCardModule,
...
export class WidgetTotalCasesComponent implements OnInit, OnDestroy, OnChanges {
