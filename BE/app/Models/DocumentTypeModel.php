...
class DocumentTypeModel extends Model
{
    ...
    public function getDocumentTypesWithRelations($filters = [])
    {
        ...
        $builder->join('`expedient_state` fs', 'fs.id = dt.id_sale_type', 'left'); // Tipo de proceso
        $builder->join('`expedient_sub_state` sp', 'sp.id = dt.id_sub_sale_type', 'left'); // Subestado de archivo
