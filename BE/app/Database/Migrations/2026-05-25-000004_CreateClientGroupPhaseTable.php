...
/**
 * Junction: which workflow phases (expedient_state rows: Integración, Liquidación,
...
class CreateClientGroupPhaseTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'id_expedient_state'   => ['type' => 'BIGINT', 'unsigned' => true, 'null' => false],
        ...
        $this->forge->addUniqueKey(['id_client_group', 'id_expedient_state']);
        $this->forge->addKey('id_expedient_state');
