...
-- en lugar de la API de Vanguardia para subir archivos.
-- Fecha: 2026-03-02
-- ============================================================================

INSERT INTO `config` (`config_key`, `config_value`, `category`, `description`, `sensitive`, `registration_date`, `update_date`) VALUES
('use_direct_backblaze_upload', '1', 'group_api_url', 'Usar subida directa a Backblaze B2 (1=si, 0=no, usa Vanguardia)', 0, NOW(), NOW())
