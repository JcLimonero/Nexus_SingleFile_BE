-- MIGRACIÓN 044: Corregir vista view_client_relations
-- La vista referenciaba tablas/columnas antiguas (PascalCase).
-- Actualizar a snake_case: client_header, client_dms_relation, client.
-- Usar backticks para evitar conflictos con palabras reservadas.
