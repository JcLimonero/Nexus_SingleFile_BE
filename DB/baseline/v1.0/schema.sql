...
--   - + file_state.requires_payment_voucher (id=2 backfilled in data.sql)
...
CREATE TABLE `client` (
  ...
  `razon_social` varchar(500) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `agency_origin` varchar(50) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `tipo_cliente` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `RazonSocial` (`razon_social`),
...
CREATE TABLE `client_identification_data` (
  ...
  `razon_social` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `numero_exterior` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_interior` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `pais_nacionalidad` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `autoridad_emite` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha_constituccion` date DEFAULT NULL,
  `actividad_giro` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- ------ Table: `document_file_error` ------
DROP TABLE IF EXISTS `document_file_error`;
CREATE TABLE `document_file_error` (
  `id` int NOT NULL,
  `registration_date` timestamp NULL DEFAULT NULL,
  `update_date` timestamp NULL DEFAULT NULL,
  `id_last_user_update` bigint DEFAULT '0',
...
-- ------ Table: `document_file_status` ------
DROP TABLE IF EXISTS `document_file_status`;
CREATE TABLE `document_file_status` (
  `id` int NOT NULL,
  `registration_date` timestamp NULL DEFAULT NULL,
  `update_date` timestamp NULL DEFAULT NULL,
  `id_last_user_update` bigint DEFAULT '0',
...
CREATE TABLE `expedient` (
  ...
  `enabled` tinyint DEFAULT '1',
  `description` varchar(500) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `id_current_state` int DEFAULT '0',
  ...
  KEY `WDIDX_File_IdIdCurrentState` (`id`,`id_current_state`),
  KEY `IDX_File_RegistrationDate_IdAgency` (`registration_date`,`id_agency`),
  KEY `IDX_File_RegistrationDate_IdAgency_IdCurrentState` (`registration_date`,`id_agency`,`id_current_state`),
...
CREATE TABLE `file_document` (
  ...
  `id_current_status` int DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `WDIDX_DocumentByFile_IdFile` (`id_file`),
  KEY `WDIDX_DocumentByFile_IdDocumentType` (`id_document_type`),
  KEY `WDIDX_DocumentByFile_IdCurrentStatus` (`id_current_status`),
  KEY `WDIDX_DocumentByFile_IdDocumentError` (`id_document_error`),
  KEY `IDX_DocumentByFile_File_Status` (`id_file`,`id_current_status`),
  KEY `IDX_DocumentByFile_Type_Status` (`id_document_type`,`id_current_status`),
  KEY `IDX_DocumentByFile_File_Type` (`id_file`,`id_document_type`),
  ...
  CONSTRAINT `file_document_ibfk_3` FOREIGN KEY (`id_current_status`) REFERENCES `document_file_status` (`id`),
  CONSTRAINT `file_document_ibfk_4` FOREIGN KEY (`id_document_error`) REFERENCES `document_file_error` (`id`),
  CONSTRAINT `FK_file_document_IdFile` FOREIGN KEY (`id_file`) REFERENCES `expedient` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
-- ------ Table: `file_exception_reason` ------
DROP TABLE IF EXISTS `file_exception_reason`;
CREATE TABLE `file_exception_reason` (
  `id` int NOT NULL,
  `name` varchar(500) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
-- ------ Table: `file_pld` ------
DROP TABLE IF EXISTS `file_pld`;
CREATE TABLE `file_pld` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
-- ------ Table: `file_pld_approved_document` ------
DROP TABLE IF EXISTS `file_pld_approved_document`;
CREATE TABLE `file_pld_approved_document` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_document_by_file` bigint NOT NULL COMMENT 'FK to file_document.id',
  `id_file` bigint NOT NULL COMMENT 'FK to expedient.id',
  `approved_by_client` tinyint(1) DEFAULT '1' COMMENT '1=Approved by client',
  `approval_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_approved_doc_iddocumentbyfile` (`id_document_by_file`),
  KEY `idx_approved_doc_idfile` (`id_file`),
  CONSTRAINT `fk_approved_doc_documentbyfile` FOREIGN KEY (`id_document_by_file`) REFERENCES `file_document` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_approved_doc_file` FOREIGN KEY (`id_file`) REFERENCES `expedient` (`id`) ON DELETE CASCADE
...
-- ------ Table: `file_pld_beneficial_owner` ------
DROP TABLE IF EXISTS `file_pld_beneficial_owner`;
CREATE TABLE `file_pld_beneficial_owner` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
-- ------ Table: `file_pld_geo_log` ------
DROP TABLE IF EXISTS `file_pld_geo_log`;
CREATE TABLE `file_pld_geo_log` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
-- ------ Table: `file_reasons` ------
DROP TABLE IF EXISTS `file_reasons`;
...
-- ------ Table: `file_share_token` ------
DROP TABLE IF EXISTS `file_share_token`;
CREATE TABLE `file_share_token` (
  ...
  UNIQUE KEY `uk_share_token_idfile` (`id_file`),
  ...
  CONSTRAINT `fk_share_token_file` FOREIGN KEY (`id_file`) REFERENCES `expedient` (`id`) ON DELETE CASCADE
...
-- ------ Table: `file_state` (renamed from `file_status`) ------
...
-- ------ Table: `file_sub_state` (renamed from `file_sub_status`) ------
...
-- ------ Table: `files_to_correct` ------
DROP TABLE IF EXISTS `files_to_correct`;
CREATE TABLE `files_to_correct` (
...
CREATE TABLE `liquidation_receipt_detail` (
  ...
  `id_last_user_update` bigint DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_file_document` (`id_file_document`),
  KEY `id_file` (`id_file`),
  KEY `id_payment_method` (`id_payment_method`),
  CONSTRAINT `liquidation_receipt_detail_ibfk_1` FOREIGN KEY (`id_file_document`) REFERENCES `file_document` (`id`),
  CONSTRAINT `liquidation_receipt_detail_ibfk_2` FOREIGN KEY (`id_file`) REFERENCES `expedient` (`id`),
...
-- company.id_client_group + file_state.requires_payment_voucher
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY INVOKER VIEW `view_all_relations` AS select `f`.`Id` AS `IdFile`,`f`.`IdOrderTotal` AS `numeroPedido`,`f`.`IdInventary` AS `numeroInventario`,`f`.`IdAgency` AS `idAgencyFile`,`a`.`IdAgency` AS `idAgencyDMS`,`ctr`.`IdTotalDealer` AS `IdTotalDealer`,`ctr`.`IdAgency` AS `idAgencyClient`,`p`.`Name` AS `proceso`,`ot`.`Name` AS `operacion`,`ct`.`Name` AS `tipoCliente`,`obc`.`CarType` AS `version`,`obc`.`Year` AS `year`,`obc`.`Modelo` AS `modelo`,`obc`.`VIN` AS `vin`,`a`.`Name` AS `agencia`,`f`.`RegistrationDate` AS `fechaRegistro`,`fs`.`Name` AS `estatus`,`c`.`Name` AS `Name`,`c`.`LastName` AS `LastName`,`c`.`MotherLastName` AS `MotherLastName` from (((((((((`file` `f` left join `process` `p` on((`f`.`IdProcess` = `p`.`Id`))) left join `operationtype` `ot` on((`f`.`IdOperation` = `ot`.`Id`))) left join `customertype` `ct` on((`f`.`IdCustomerType` = `ct`.`Id`))) left join `agency` `a` on((`f`.`IdAgency` = `a`.`Id`))) left join `file_state` `fs` on((`f`.`IdCurrentState` = `fs`.`Id`))) left join `orderbycar` `obc` on((`f`.`IdOrderTotal` = `obc`.`IdTotalDealer`))) left join `client` `c` on((`c`.`Id` = `f`.`IdClient`))) left join `headerclient` `h` on((`h`.`IdClient` = `c`.`Id`))) left join `client_total_relation` `ctr` on((`ctr`.`idHeaderClient` = `h`.`Id`))) order by `f`.`RegistrationDate` desc;

DROP VIEW IF EXISTS `view_client`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY INVOKER VIEW `view_client` AS select `c`.`Id` AS `Id`,`c`.`Name` AS `Name`,`c`.`LastName` AS `LastName`,`c`.`MotherLastName` AS `MotherLastName`,`c`.`RFC` AS `RFC`,`c`.`CURP` AS `CURP`,`c`.`TelNumber` AS `TelNumber`,`c`.`TelNumber2` AS `TelNumber2`,`c`.`RegistrationDate` AS `RegistrationDate`,`c`.`UpdateDate` AS `UpdateDate`,`c`.`IdLastUserUpdate` AS `IdLastUserUpdate`,`c`.`Adviser` AS `Adviser`,`c`.`Email` AS `Email`,`c`.`RazonSocial` AS `RazonSocial`,`c`.`AgencyOrigin` AS `AgencyOrigin`,`ctr`.`IdTotalDealer` AS `ndClient`,`a`.`Id` AS `idAgency` from (((`client` `c` join `headerclient` `hc` on((`c`.`Id` = `hc`.`IdClient`))) join `client_total_relation` `ctr` on((`ctr`.`idHeaderClient` = `hc`.`Id`))) join `agency` `a` on((`ctr`.`IdAgency` = `a`.`Id`)));
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY INVOKER VIEW `view_document_name` AS select `fd`.`id` AS `IdFileDocument`,`fd`.`id_file` AS `IdFile`,coalesce(`dt`.`name`,`fd`.`name`) AS `file_name_original` from (`file_document` `fd` left join `document_type` `dt` on((`fd`.`id_document_type` = `dt`.`id`))) where (`fd`.`enabled` = 1);

DROP VIEW IF EXISTS `view_files`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY INVOKER VIEW `view_files` AS select `f`.`Id` AS `fileId`,`f`.`IdOrderTotal` AS `numeroPedido`,`f`.`IdInventary` AS `numeroInventario`,`p`.`Name` AS `proceso`,`ot`.`Name` AS `operacion`,`ct`.`Name` AS `tipoCliente`,`obc`.`CarType` AS `version`,`obc`.`Year` AS `year`,`obc`.`Modelo` AS `modelo`,`obc`.`VIN` AS `vin`,`a`.`Name` AS `agencia`,`f`.`RegistrationDate` AS `fechaRegistro`,`fs`.`Name` AS `estatus`,`a`.`IdAgency` AS `IdAgency` from ((((((`file` `f` left join `process` `p` on((`f`.`IdProcess` = `p`.`Id`))) left join `operationtype` `ot` on((`f`.`IdOperation` = `ot`.`Id`))) left join `customertype` `ct` on((`f`.`IdCustomerType` = `ct`.`Id`))) left join `agency` `a` on((`f`.`IdAgency` = `a`.`Id`))) left join `file_state` `fs` on((`f`.`IdCurrentState` = `fs`.`Id`))) left join `orderbycar` `obc` on(((`f`.`IdOrderTotal` = `obc`.`IdTotalDealer`) and (`obc`.`idAgency` = `f`.`IdAgency`))));

DROP VIEW IF EXISTS `view_files_by_client`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY INVOKER VIEW `view_files_by_client` AS select `f`.`Id` AS `Id`,`f`.`IdClient` AS `IdClient`,`f`.`IdOrder` AS `IdOrder`,`f`.`IdCustomerType` AS `IdCustomerType`,`f`.`IdOperation` AS `IdOperation`,`f`.`IdProcess` AS `IdProcess`,`f`.`RegistrationDate` AS `RegistrationDate`,`f`.`UpdateDate` AS `UpdateDate`,`f`.`LastUserUpdate` AS `LastUserUpdate`,`f`.`IdAgency` AS `IdAgency`,`f`.`IdSeller` AS `IdSeller`,`f`.`IdLastUserUpdate` AS `IdLastUserUpdate`,`f`.`Description` AS `Description`,`f`.`IdCurrentState` AS `IdCurrentState`,`f`.`IdOrderTotal` AS `IdOrderTotal`,`f`.`AttentionDate` AS `AttentionDate`,`f`.`CloseDate` AS `CloseDate`,`f`.`AgendHour` AS `AgendHour`,`f`.`AgendDate` AS `AgendDate`,`f`.`IdInventary` AS `IdInventary`,`vc`.`Name` AS `Name`,`vc`.`LastName` AS `LastName`,`vc`.`MotherLastName` AS `MotherLastName`,`vc`.`CURP` AS `CURP`,`vc`.`ndClient` AS `ndClient`,`vc`.`AgencyOrigin` AS `AgencyOrigin`,`vc`.`Email` AS `Email`,`vc`.`RazonSocial` AS `RazonSocial`,`vc`.`TelNumber` AS `TelNumber`,`vc`.`TelNumber2` AS `TelNumber2` from (`file` `f` join `view_client` `vc` on((`f`.`IdClient` = `vc`.`Id`)));
